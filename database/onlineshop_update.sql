...
VALUES (
        ...
        'admin',
        'admin@gmail.com',
        '$2y$10$xNbzNLNimGINJJZuOJSvY.hWMzOie70Cq3Xq4zJTbZZPGxLEBSRm6'
    );
...
VALUES (
        ...
        'Kingdom Tập 1',
        45000,
        'Trước Công Nguyên, tại nước Tần ở phía tây Trung hoa, hai cậu thiếu niên mồ côi tên Tín và Phiêu ngày đêm luyện tập võ nghệ, với mong ước một ngày nào đó sẽ trở thành “Thiên hạ đệ nhất đại tướng quân”. Do có diện mạo giống hệt Tần vương, Phiêu được mời vào cung để làm thế thân cho ngài. Thế nhưng, cậu đã mất mạng vì Vương đệ Thành Kiểu làm phản nhằm tranh đoạt ngôi vị. Tín dù rất hận Tần vương nhưng vì di nguyện của Phiêu, cậu quyết định trợ giúp cho vị vua trẻ đoạt lại ngai vàng và cùng ngài thực hiện tâm nguyện thống nhất toàn vẹn lãnh thổ trung Hoa.',
        'kingdom.jpg',
        'kingdom tap 1',
        0
    ), (
        ...
        'Ikigami Tập 1',
        45000,
        'Để người dân thẩu hiểu giá trị sinh mệnh, một đạo luật mang lên “Luật duy trì phồn thịnh quốc gia” đã được ban hành.\n
...
VALUES (
        ...
        'A',
        'user1@gmail.com',
        '$2y$10$iusesomecrazystrings2uqHAmBhvLR.JnKVUDmhFIwNtiqWwa4We',
        '0123456789',
        'Quận 1',
        'Tp.HCM'
    ), (
